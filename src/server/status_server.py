...
def _build_config_payload(ctx: dict, state: dict, bot_status: dict) -> dict:
    ...
    return {
        ...
        "FV_EDGE_MAX_MTE": _instance_env(ctx, control, "FV_EDGE_MAX_MTE", "2.0"),
        "FV_EDGE_MAX_OPEN_POSITIONS": _instance_env(ctx, control, "FV_EDGE_MAX_OPEN_POSITIONS", "1"),
        "FV_EDGE_MAX_BTC_AGE_SECONDS": _instance_env(ctx, control, "FV_EDGE_MAX_BTC_AGE_SECONDS", "10"),
    ...
    def do_GET(self):
        ...
        # === 配置 ===
            ...
            config = {
                ...
                "FV_EDGE_MAX_MTE": _env("FV_EDGE_MAX_MTE", "2.0"),
                "FV_EDGE_MAX_OPEN_POSITIONS": _env("FV_EDGE_MAX_OPEN_POSITIONS", "1"),
                "FV_EDGE_MAX_BTC_AGE_SECONDS": _env("FV_EDGE_MAX_BTC_AGE_SECONDS", "10"),
